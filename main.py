...
def handle_transfers(msg):
    ...
    bot.send_message(
        msg.chat.id,
        "🔔 في هذه العملية يمكنك تحويل المصاري التي في محفظتك إلى شركات مثل الهرم ليقوم من يشاء باستلامها، أو يمكنك تحويلها إلى أرصدة كاش سيرياتيل أو MTN."
    )
    # بعدها اعرض قائمة التحويلات كالمعتاد
